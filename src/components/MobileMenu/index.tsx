...
function Main() {
  ...
  return (
    <>
      ...
      <div
        className={clsx([
          "w-full bg-primary/90 z-[60] border-b border-white/[0.08] -mt-5 -mx-3 sm:-mx-8 mb-6 dark:bg-darkmode-800/90 md:hidden",
      ...
      >
        <div className="h-[70px] mt-2 px-3 sm:px-8 flex items-center">
        ...
        <div
          ref={scrollableRef}
          className={clsx([
            "h-screen z-50 top-0 left-0 w-[270px] -ml-[100%] bg-primary transition-all duration-300 ease-in-out dark:bg-darkmode-800",
